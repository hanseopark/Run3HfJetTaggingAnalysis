...
root -x -l -b -q "task/plotSV.cxx(\"$DATA_FILE_PATH\", \"$SIM_FILE_PATH\", \"$SOURCE_SET\", \"$DATA_SET\", \"$MC_SET\", \"$TRIGGER_NAME\", \"$SUFFIX\", $INCLUSION_TYPE, $USE_LOG_SCALE, $PROCESS_DATA, $PROCESS_MCD, $PROCESS_MCP, $FILL_RUN2DEF, $PROCESS_TEST, $PROCESS_2PRONG, $PROCESS_3PRONG, $FILL_N1, $FILL_EFFI)"
