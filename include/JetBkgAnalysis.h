...
class JetAnalysis {
  public:
    JetAnalysis(const TString rootData, const TString rootSim, bool doData, bool doMC, bool dopartLevel, TString trigger) {
      if (doData) {
        LoadDataBkgQA(rootData.Data());
        InitHistogramForNormalizationBkgQAData();
      	ProjectionHistBkgQAData();
      	CloneNormalizedHistogramBkgQAData();
      	NormalizedHistogramBkgQAData();
      }
      if (doMC) {
        LoadSimBkgQA(rootSim.Data(), dopartLevel);
        InitHistogramForNormalizationBkgQAMC(dopartLevel);
      	ProjectionHistBkgQAMC(dopartLevel);
      	CloneNormalizedHistogramBkgQAMC(dopartLevel);
      	NormalizedHistogramBkgQAMC(dopartLevel);
      }
      SaveHistogramBkgQA("GeneralJetQA.root", doData, doMC, dopartLevel);
    }

    ~JetAnalysis();

    // function
    int LoadDataBkgQA(TString rootData);
    int LoadSimBkgQA(TString rootSim, bool dopartLevel);
    void InitHistogramForNormalizationBkgQAData();
    void InitHistogramForNormalizationBkgQAMC(bool dopartLevel);
    void ProjectionHistBkgQAData();
    void ProjectionHistBkgQAMC(bool dopartLevel);
    void CloneNormalizedHistogramBkgQAData();
    void CloneNormalizedHistogramBkgQAMC(bool dopartLevel);
    void NormalizedHistogramBkgQAData();
    void NormalizedHistogramBkgQAMC(bool dopartLevel);
    void SaveHistogramBkgQA(TString rootFile, bool doData, bool doMC, bool dopartLevel);
...
int JetAnalysis::LoadDataBkgQA(TString rootData) {
...
int JetAnalysis::LoadSimBkgQA(TString rootSim, bool dopartLevel = false) {
...
void JetAnalysis::InitHistogramForNormalizationBkgQAData() {
  for (int binJetR =0; binJetR < GeneralJet::nBinsJetR+1; binJetR++) {
...
void JetAnalysis::InitHistogramForNormalizationBkgQAMC(bool dopartLevel = false) {
  for (int binJetR =0; binJetR < GeneralJet::nBinsJetR+1; binJetR++) {
...
void JetAnalysis::ProjectionHistBkgQAData() {
...
void JetAnalysis::ProjectionHistBkgQAMC(bool dopartLevel= false) {
...
void JetAnalysis::CloneNormalizedHistogramBkgQAData() {
  for (int binJetR =0; binJetR < GeneralJet::nBinsJetR+1; binJetR++) {
...
void JetAnalysis::CloneNormalizedHistogramBkgQAMC(bool dopartLevel) {
  for (int binJetR =0; binJetR < GeneralJet::nBinsJetR+1; binJetR++) {
...
void JetAnalysis::NormalizedHistogramBkgQAData() {
  for (int binJetR =0; binJetR < GeneralJet::nBinsJetR+1; binJetR++) {
...
void JetAnalysis::NormalizedHistogramBkgQAMC(bool dopartLevel=false) {
  for (int binJetR =0; binJetR < GeneralJet::nBinsJetR+1; binJetR++) {
...
void JetAnalysis::SaveHistogramBkgQA(TString rootFile, bool doData, bool doMC, bool dopartLevel) {
