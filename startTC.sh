...
echo "fill z: ${15}"
echo "fill xyz: ${16}"
echo "fill Effi and purity for TC: ${17}"

root -x -l -b -q "task/plotTC.cxx(\"$DATA_FILE_PATH\", \"$SIM_FILE_PATH\", \"$SOURCE_SET\", \"$DATA_SET\", \"$MC_SET\", \"$TRIGGER_NAME\", \"$SUFFIX\", $INCLUSION_TYPE, $USE_LOG_SCALE, $PROCESS_DATA, $PROCESS_MCD, $PROCESS_MCP, $FILL_RUN2DEF, $FILL_XY, $FILL_Z, $FILL_XYZ, $FILL_EFFI)"
